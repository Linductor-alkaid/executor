...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: $0 [--version 0.3.0] [--build-type Release|Debug] [--build-static true|false] [--build-shared true|false] [--build-tests true|false] [--build-examples true|false] [--build-dir build_linux] [--output-dir dist] [--package-deb true|false] [--deb-package-type all|dev|runtime] [--maintainer \"Name <email>\"]"
            exit 1
            ;;
    esac
done
