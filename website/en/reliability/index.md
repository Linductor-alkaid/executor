...
2. [Monitoring and sampling](/en/reliability/monitoring): collect task statistics or a full lifecycle snapshot with the required precision and acceptable overhead.
...
4. [Linux, Windows, and Android deployment](/en/reliability/platform-deployment): verify builds, CPU availability, real-time permissions, memory locking, Android CPU-only fallback, and platform-specific behavior actually take effect.
