...
先看这些组件如何连接成[完整机器人数据流水线](/zh/tutorial/complete-robot-pipeline)；普通后台任务的选择请看[如何选择提交接口](/zh/guides/choosing-submit-api)，需要专用周期线程时进入[实时与通信](/zh/realtime-and-communication/)。
